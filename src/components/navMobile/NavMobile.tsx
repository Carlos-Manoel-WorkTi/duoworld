...
const NavMobile: React.FC<PropHeaderITC> = ({active}) => {
  const icons = {
      home: (
        <Icon  id={active === "NHome" ? "NHome" : ""} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2">
      ...
      pencil: (
        <Icon id={active === "NWords" ? "NWords" : ""} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2">
      ...
      book: (
          <Icon id={active === "NHistories" ? "NHistories" : ""} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2">
            <path d="M6 2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H6zm0 2h12v16H6V4zm2 0v16m8-16v16"/>
          </Icon>
        ),
      user: (
          <Icon id={active === "NUser" ? "NUser" : ""} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="0">
