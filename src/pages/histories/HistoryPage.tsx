...
import { ContainerPages, ContainerTranslate, FaqButton, FaqIcon, HiddenCheckbox, MuteSpeaker, MuteSpeakerIcon, NPage, Speaker, SpeakerIcon, TextPage, ToggleSwitch, Tooltip } from './style/HistoryPageStyle';
import DataBook from './script/DataBook';
import SubHeader from '../../components/subHeader/SubHeader';
import { calculateReadingPercentage, NavigateHistory, Params } from './script/Methods';
...
export default function HistoryPage() {
  ...
  useEffect(() => {
    ...
    if (storage) {
      ...
      const updatedPageStopped = currentPage > lastPageStopped ? currentPage : lastPageStopped;
      const pct = calculateReadingPercentage(updatedPageStopped, DataBook.book.totalPages).toFixed(0);
